@{
    ...
    Description       = 'Reads Jira: fields, issues, JQL searches and change history. It has no write path at all, because the pipelines in this estate already transition issues themselves and two writers produce double transitions.'
